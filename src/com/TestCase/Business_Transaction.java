...
public class Business_Transaction {
    ...
    public void CreateBusiness_Transaction() throws InterruptedException {
        ...
        myDynamicElement.sendKeys("Extron Stakeholder Group");
        Thread.sleep(2000);
       ...
       //Save
        ...
        String ExpectedValue = "Business Transaction Library \"Business_Transaction\" was created.";
