...
public class Data_Table {
    ...
    public void CreateData_Table() throws InterruptedException {
       ...
       //Associated System
        ...
        //Data Table Name
        driver.findElement(By.xpath("//input[@class=\" input\"]")).sendKeys("Data_Table");
        Thread.sleep(2000);
        ...
        myDynamicElement.sendKeys("Techcloud Developer");
        Thread.sleep(3000);
        ...
        String ExpectedValue = "Data Table \"Data_Table\" was created.";
